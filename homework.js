...
function quickSort(array) {
  ...
  // return quickSort(smaller).concat(equals).concat(quickSort(bigger))
  return [...quickSort(smaller), ...equals, ...quickSort(bigger)]; // SPREAD OPERATOR
}
...
function merge(arr1, arr2) {
  ...
  // return [...final, ...arr1.slice(idx1), ...arr2.slice(idx2)]
