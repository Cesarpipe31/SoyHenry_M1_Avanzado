...
function sumaDeArrays(array) {
  ...
  // Desafio: Hay que sumar los elementos de cada sub array que contenga dos elementos o mas, devolviendo
  //la suma del mismo como 1 solo elemento
  // Pero si el elemento dentro del array que ingresa por prop, ya es de tipo number, deben devolverlo como
  //tal dentro del array que retornan.
  // Ejemplo
  //let array = [1, [2, 3], 4]
  // --> [1, 5, 4]
